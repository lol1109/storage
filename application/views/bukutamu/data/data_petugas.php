                    ...
                    <table id="data" class="table card-table table-vcenter text-nowrap datatable ">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?= $dt->password; ?></td>
                          <td>
                            <?= anchor('index.php/Petugas/Edit/'.$dt->id_petugas, '<button class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-plus" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <?= anchor('index.php/Petugas/hapus_petugas/'.$dt->id_petugas, '<button type="button" class="btn btn-danger" data-bs-dismiss="modal">Ya, hapus data ini</button>'); ?>
