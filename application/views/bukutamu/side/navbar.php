      ...
      <header class="navbar navbar-expand-md navbar-dark d-print-none">
                  <div class="container-xl">
                    ...
                    <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                      <a href="<?= base_url('index.php/Fungsi/index') ?>">
                        APLIKASI BUKU TAMU
                      </a>
                    </h1>
                      ...
                      <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
                        <ul class="navbar-nav">
                          <li class="nav-item active">
                            <a class="nav-link" href="<?= base_url('index.php/Fungsi/index') ?>" >
                           ...
                           <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="<?= base_url('index.php/Fungsi/tambah') ?>">
                                tamu
                              </a>
                              <a class="dropdown-item" href="<?= base_url('index.php/Petugas/tambah_petugas') ?>">
                                petugas
                              </a>
                              <a class="dropdown-item" href="<?= base_url('index.php/Cabang/tambah_cabang') ?>">
                                cabang
                              </a>
                            </div>
                          </li>
                          <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="<?= base_url('index.php/Cabang/data') ?>">
                                cabang
                              </a>
