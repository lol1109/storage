          	...
          	<div class="row">
                ...
                <div class="card justify-content-center">
                  <div class="card-header bg-primary text-white">
                    <h3 class="card-title">Upload Data Home</h3>
                    <div class="card-actions">
                     <a class="btn btn-success" href="<?= base_url('Fungsi/back'); ?>">Kembali</a>
                   </div>
                  </div>
                  <div class="card-body">
                          <?= form_open_multipart('Fungsi/tambah_home') ?>
                            <div class="row">
                              <div class="mb-3">
                             ...
                             <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="action" placeholder="VARIO" value="<?= set_value('action') ?>">
                            ...
                            <div class="text-muted">
                              Ket: Tambah <br class="d-none d-sm-block"> Untuk membuat teks menjadi terpisah kebawah
                            </div>
                            <div class="row">
