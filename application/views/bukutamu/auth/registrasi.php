        ...
        <form action="<?= base_url('index.php/Auth/registrasi_akun') ?>" class="card card-md" method="post" autocomplete="off" validate>
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control"  name="gmail" placeholder="Enter email" checked required>
            </div>

             <div class="mb-3">
              <label class="form-label">Username</label>
              <input type="text" class="form-control"  name="username" placeholder="Enter Username" checked required>
            </div>
