...
--
-- Host: localhost:3306
-- Generation Time: Jul 26, 2023 at 02:35 AM
...
(63, 16, '2023-06-26', 'vario 123', 'cover6.jpg', '', ''),
(71, 16, '2023-07-12', 'vario 123', 'cover6.jpg', '', '');
...
(1, 'Jual Beli Tanpa Riba', 'tanpa riba', 'see more', 'cover111.jpg');
...
INSERT INTO `tahapan` (`id`, `icon`, `judul`, `desc`) VALUES
(1, 'bunga16.png', 'Jual Beli Tanpa RIba', 'tanpa bunga sepeserpun'),
(2, 'bunga17.png', 'Mudah & Cepat', 'desc'),
(3, 'bunga18.png', 'tanpa riba', 'desc'),
(4, 'cover2.jpg', 'dadwda', 'daeaefa');
...
INSERT INTO `tamu` (`id_tamu`, `Nama`, `Kontak`, `noWa`, `Bidang`, `Tujuan`, `JenisInformasi`, `Informasi`, `Kesimpulan`, `tanggal`, `cabang`, `petugas`, `deleted`) VALUES
(16, 'ihsan', '0813293761278', '09276837162332', 'Elang Motor', 'Konsultasi', 'data', 'Youtube', '', '2023-05-17', 1, 5, 'no'),
(19, 'budi', '081329376213', '08123456780', 'Elang Property', 'Pengajuan', 'data', 'Website', '', '2023-05-19', 1, 2, 'yes'),
(20, 'budi', '08132937612', '09276837162', 'Elang Property', 'Konsultasi', 'data', 'Postingan Instargam', 'mkjbhvhgv', '2023-05-24', 1, 2, 'yes'),
(22, 'budi', '08123456780', '08123456780', 'Elang Motor', 'Konsultasi', 'dDaAd', 'Postingan Instargam', '', '2023-05-25', 9, 5, 'no'),
(25, 'fandy', '08123456789', '08123456789', 'Elang Property', 'Konsultasi', 'data', 'iklan Instargam', '', '2023-04-21', 1, 2, 'no'),
(27, 'budianto', '0813293761279', '0927683716233', 'Elang Motor', 'Pengajuan', 'data', 'Postingan Instargam', '', '2023-05-24', 1, 2, 'no'),
(29, 'marwan', '0856125362323', '0856125362323', 'Elang Property', 'Konsultasi', 'data', 'iklan google', '', '2023-06-12', 12, 5, 'no'),
(30, 'ihsan', '0813293761275', '092768371623325', 'Elang Property', 'Konsultasi', 'sdasda', 'Postingan Instargam', '', '2023-06-21', 1, 1, 'no'),
(31, 'fandy', '08132937612753', '092768371623323', 'Elang Property', 'Konsultasi', 'sdasda', 'Postingan Instargam', '', '2023-07-12', 1, 1, 'yes');
...
INSERT INTO `tanya` (`id`, `judul`, `button`) VALUES
(1, 'Butuh Informasi Lebih Lanjut? Tentang Beli Motor Tanpa Riba', 'Hubungi Kami sekarang');
...
--
ALTER TABLE `tamu`
  MODIFY `id_tamu` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
